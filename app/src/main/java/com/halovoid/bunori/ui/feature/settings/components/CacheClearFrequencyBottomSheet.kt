...
@Composable
fun CacheClearFrequencyBottomSheet(
    currentFrequency: String,
    onFrequencySelected: (String) -> Unit,
    onDismiss: () -> Unit
) {
    val options = listOf("Off", "Daily", "Every 2 Days", "Every 4 Days", "Every 7 Days")

    AppBottomSheet(
        onDismiss = onDismiss,
        title = "Cache Clearing Frequency",
        subtitle = "Choose how often cached reading chapters are automatically purged."
    ) {
        AppBottomSheetGroup {
